...
MODEL = 'base'        # 'base' or 'finetuned'
CLIP_SET = 'all'       # 'all' (all clips, base model only) or 'heldout' (33 held-out clips)
...
# ============================================================
# PATHS -- fill in / confirm before running
# ============================================================

TEST_CLIPS_FILE = './test_clips.txt'
RECORDINGS_DIR = './finetuning_dataset/recordings'  # <-- confirm this matches the laptop layout

CHECKPOINT_PATHS = {
    'base': './checkpoints/base_train_eventcount_10k/checkpoint_best.pth',  # <-- confirm this path
    'finetuned': './checkpoints/finetune_genx320_raw_50k/checkpoint_latest.pth',
}
